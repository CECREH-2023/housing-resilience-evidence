...
```mermaid
timeline
 title Publication density by year (selected housing resilience corpus, n=40)
 2007: 1
 2008: 1
 2009: 2
 2013: 1
...
```mermaid
pie title Thematic distribution (n=40)
 "Informal settlements / upgrading / CLTs": 11
 "Participatory governance & program design": 7
 "Self-recovery & household agency": 6
 "Equity, tenure & displacement": 2
 "Relocation, buyouts & managed retreat": 14
```
